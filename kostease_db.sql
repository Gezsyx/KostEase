...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Okt 2025 pada 09.35
...
(1, 'admin1@gmail.com', 'admin01', 'adminpassword456'),
(2, 'admin2@gmail.com', 'admin02', 'adminpassword789');
...
(11, 'B101', 'Single', 800000.00, 'Tersedia'),
(12, 'B102', 'Berdua', 1200000.00, 'Tersedia'),
(13, 'B103', 'Berdua', 1200000.00, 'Tersedia'),
(14, 'B104', 'Berdua', 1200000.00, 'Tersedia');
...
INSERT INTO `kasir` (`id_kasir`, `email`, `username`, `password`) VALUES
(1, 'kasir1@gmail.com', 'kasir01', 'password123'),
(2, 'kasir2@gmail.com', 'kasir02', 'password456'),
(3, 'kasir3@gmail.com', 'kasir03', 'password789');
